          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
              <div className="bg-[#262626] border border-[#333] rounded-xl p-4 sm:p-5 flex flex-col gap-4 shadow-md">
                <div className="flex gap-3.5 items-start">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5">
                      <h1 className="text-base sm:text-lg font-bold text-white leading-tight truncate">Aditya Thakur</h1>
                ...
                <p className="text-zinc-300 italic text-xs bg-[#1f1f1f] p-2.5 rounded-lg border border-[#333] whitespace-pre-wrap">
                  "{bio}"
                </p>
                ...
                <div className="border-t border-[#333] pt-3.5 flex flex-col gap-2.5 text-zinc-400 text-xs">
                  ...
                  <a href="https://github.com/aditya0563" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 hover:text-[#ffa116] transition-colors truncate">
                    ...
                    <span className="truncate">aditya0563</span>
                  </a>

                  <a href="https://x.com/adityathakur" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 hover:text-[#ffa116] transition-colors truncate">
                    <svg className="w-4 h-4 text-zinc-500 fill-current flex-shrink-0" viewBox="0 0 24 24">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                    <span className="truncate">adityathakur</span>
                  </a>

                  <a href="https://linkedin.com/in/aditya-thakur-1507091aa" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 hover:text-[#ffa116] transition-colors truncate">
                    <svg className="w-4 h-4 text-zinc-500 fill-current flex-shrink-0" viewBox="0 0 24 24">
                      <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"/>
                    </svg>
                    <span className="truncate">aditya-thakur-1507091aa</span>
                  </a>
                </div>
              ...
              <div className="bg-[#262626] border border-[#333] rounded-xl p-4 sm:p-5 flex flex-col gap-3 shadow-md">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                  <div className="flex items-center gap-1.5 text-xs sm:text-sm">
                    <span className="text-base sm:text-lg font-bold text-white tracking-tight">{totalSubmissionsPastYear}</span>
